...
// Fields with group: 'Operating Hours' are grouped accordingly.
...
export const FMX_API_STANDARD_FIELDS = {
  ...
  'Equipment': [
    ...
    { name: 'Asset Condition', apiKey: 'assetCondition', required: false, type: 'string' },
  ...
  'Inventory': [
    { name: 'Name', apiKey: 'name', required: true, type: 'string' },
    { name: 'Building', apiKey: null, required: true, type: 'string', crossSheet: 'Building' },
    { name: 'Location', apiKey: 'locationName', required: true, type: 'string' },
  ...
  'Resource': [
    ...
    { name: 'Latitude', apiKey: 'latitude', required: false, type: 'number' },
    { name: 'Longitude', apiKey: 'longitude', required: false, type: 'number' },
    { name: 'Resource type', apiKey: 'resourceType', required: false, type: 'string' },
    { name: 'Capacity', apiKey: 'capacity', required: false, type: 'number' },
    { name: 'Quantity', apiKey: 'quantity', required: false, type: 'number' },
