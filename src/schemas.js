...
export const FMX_SCHEMAS = {
  ...
  Resource: {
    fields: [
      ...
      { name: "Is location", required: false, type: "string" },
  ...
  "Work Request": {
    fields: [
      ...
      { name: "Equipment Items", required: false, type: "string" },
      { name: "Due Date", required: true, type: "date" },
    ],
    crossRef: null,
  },
  "Schedule Request": {
    fields: [
      ...
      { name: "Event Time", required: false, type: "string" },
      { name: "Reservation Time", required: false, type: "string" },
      { name: "Setup Time", required: false, type: "string" },
      { name: "Teardown Time", required: false, type: "string" },
      // firstOccurrenceEventTimeBlock
      { name: "Event Start Date",      required: false, type: "date" },
      { name: "Event End Date",        required: false, type: "date" },
      { name: "Event Start Time",      required: false, type: "string" },
      { name: "Event End Time",        required: false, type: "string" },
      // Recurrence (schedule object)
      { name: "Recurrence Frequency",  required: false, type: "string" },
      { name: "Recurrence Interval",   required: false, type: "number" },
      { name: "Recurrence Days",       required: false, type: "string" },
      { name: "Monthly Recurrence",    required: false, type: "string" },
      { name: "Recurrence End Date",   required: false, type: "date" },
      { name: "Recurrence End Count",  required: false, type: "number" },
    ],
    crossRef: null,
  },
  "Work Task": {
